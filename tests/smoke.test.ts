...
describe("CLI scaffold", () => {
  ...
  it("prints a concise usage error when run without arguments", () => {
    ...
    expect(result.stderr).toBe("exactly one nonblank chat is required\n");
  });

  it("runs through a linked package path", () => {
